...
transformed parameters {
  ...
  for (n in 1:N) {
    ...
    beta_a[n] = alpha + eta_o[tid[n,2]] * sigma_o - eta_d[tid[n,1]] * sigma_d - eta_p[tid[n,2]] * sigma_p;
  }
...
model {
  ...
  target += half_normal_lpdf(sigma_p | sigma_p_mu, sigma_p_sigma);
